      ...
      case 'getShowcase':
        ...
        if ($AppsShowcaseCache->exists(360)) {
          ...
          $response = HTTP::getResponse([
            'url' => 'https://apps.kuuzu.org/index.php?RPC&GetShowcase&' . $version_url
          ]);
...
<div class="col-xs-3 center-block text-center">
  <img src="https://apps.kuuzu.org/public/sites/Apps/images/showcase/{{image}}" title="{{title}}: {{description}}" class="img-responsive" />
