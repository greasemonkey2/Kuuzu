  ...
  class d_partner_news {
    ...
    function getOutput() {
      ...
      if (is_array($result) && !empty($result)) {
        ...
        $output .= '    <tr>
                          <td class="text-right"><a href="https://www.kuuzu.org/Services" target="_blank">' . KUUZU::getDef('module_admin_dashboard_partner_news_more_title') . '</a></td>
                        </tr>
                      </tbody>
                    </table>';
      }
    ...
    function _getContent() {
      ...
      if ($NewsCache->exists(60)) {
        ...
        $response = HTTP::getResponse([
          'url' => 'https://www.kuuzu.org/index.php?RPC&Website&Index&GetPartnerStatusUpdates'
        ]);
