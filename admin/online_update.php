  ...
  */
  ...
  if ($VersionCache->exists(360)) {
    ...
    $releases = HTTP::getResponse([
      'url' => 'https://www.kuuzu.org/version/online_merchant/' . $major_version . $minor_version
    ]);
      ...
      case 'getReleaseNotes':
        ...
        if ($ReleaseNotesCache->exists()) {
          ...
          $notes = HTTP::getResponse([
            'url' => 'https://www.kuuzu.org/version/online_merchant/notes/' . $_POST['version'] . '.txt'
          ]);
      ...
      case 'applyRelease':
        ...
        try {
          ...
          if (is_file($work_dir . '/' . $_POST['version'] . '/Update.php')) {
            ...
            $OU = new KUU\ZU\OnlineUpdate\Update;
          ...
          if (isset($OU) && ($OU instanceof \KUU\ZU\OnlineUpdate\Update) && method_exists($OU, 'runBefore')) {
          ...
          if (isset($OU) && ($OU instanceof \KUU\ZU\OnlineUpdate\Update) && method_exists($OU, 'runAfter')) {
...
<div id="onlineUpdateContentBlock">
  <p><?php echo KUUZU::getDef('title_installed_version') . ' <strong>osCommerce Online Merchant v' . $current_version . '</strong>'; ?></p>
