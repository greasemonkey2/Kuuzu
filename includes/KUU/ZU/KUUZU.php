    ...
    public static function siteExists($site, $strict = true) {
        ...
        if (class_exists($class)) {
            if (is_subclass_of($class, 'KUU\ZU\SitesInterface')) {
                ...
                trigger_error('KUU\ZU\KUUZU::siteExists() - ' . $site . ': Site does not implement KUU\ZU\SitesInterface and cannot be loaded.');
            }
        } elseif ($strict === true) {
            trigger_error('KUU\ZU\KUUZU::siteExists() - ' . $site . ': Site does not exist.');
        }
